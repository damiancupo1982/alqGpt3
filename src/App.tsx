...
export const BUILDINGS = ['Ramos Mejia','Limay','Bolivar','Alvear','Faena','Gaboto','Gazcon','Otro'] as const;
...
export interface Tenant {
  ...
  contractUpdateEveryMonths: number; // cada cuántos meses
  contractUpdateType: 'monto' | 'porcentaje';
  contractUpdateValue: number; // monto en $ o porcentaje (ej 10 = 10%)
...
export interface Property {
  id: number;
  name: string;
  type: 'departamento' | 'galpon' | 'local' | 'oficina' | 'Gaboto';
  building: string;
  address: string;
  rent: number;
  expenses: number;
...
function App() {
  ...
  const [tenants, setTenants] = useState<Tenant[]>(() =>
    loadFromLocalStorage('tenants', [
    {
      ...
      contractStart: '2024-01-15',
      contractEnd: '2025-01-15',
      contractUpdateEveryMonths: 6,
      contractUpdateType: 'porcentaje',
      contractUpdateValue: 10,
      deposit: 50000,
      guarantor: {
        name: 'María Pérez',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold text-gray-900">Alquileres (DC3)</h1>
            </div>
